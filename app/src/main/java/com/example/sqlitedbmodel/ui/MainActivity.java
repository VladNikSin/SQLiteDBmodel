package com.example.sqlitedbmodel.ui;
...
import com.example.sqlitedbmodel.data.DatabaseAdapter;
import com.example.sqlitedbmodel.data.DatabaseHelper;
import com.example.sqlitedbmodel.R;
...
//        userList.setAdapter(userAdapter);
        ...
        adapter.open();
        ArrayAdapter arrayAdapter = new ArrayAdapter<>(this,android.R.layout.simple_list_item_1, adapter.getUsers());
    ...
    public void addRecord(View view) {
        Dialog addDialog = new Dialog(this, R.style.Theme_SQLiteDBmodel);
    ...
    private void onShowEditDialog(long id){
        Dialog editDialog = new Dialog(MainActivity.this, R.style.Theme_SQLiteDBmodel);
